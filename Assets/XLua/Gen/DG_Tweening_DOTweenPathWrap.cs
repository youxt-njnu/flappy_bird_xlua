    ...
    public class DGTweeningDOTweenPathWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DG.Tweening.DOTweenPath();
        ...
        static int _m_GetTween(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetTween(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetDrawPoints(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetDrawPoints(  );
                        translator.Push(L, gen_ret);
        ...
        static int _g_get_pathMode(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenPath gen_to_be_invoked = (DG.Tweening.DOTweenPath)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.pathMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_lockRotation(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenPath gen_to_be_invoked = (DG.Tweening.DOTweenPath)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.lockRotation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_inspectorMode(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenPath gen_to_be_invoked = (DG.Tweening.DOTweenPath)translator.FastGetCSObj(L, 1);
                translator.PushDGTweeningDOTweenInspectorMode(L, gen_to_be_invoked.inspectorMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_pathType(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenPath gen_to_be_invoked = (DG.Tweening.DOTweenPath)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.pathType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
