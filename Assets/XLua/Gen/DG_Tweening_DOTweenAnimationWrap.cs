...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOTweenAnimationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 24, 35, 35);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DORewindAllById", _m_DORewindAllById);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CreateEditorPreview", _m_CreateEditorPreview);
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "targetIsSelf", _g_get_targetIsSelf);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "targetGO", _g_get_targetGO);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "tweenTargetIsTargetGO", _g_get_tweenTargetIsTargetGO);
			...
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "targetIsSelf", _s_set_targetIsSelf);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "targetGO", _s_set_targetGO);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "tweenTargetIsTargetGO", _s_set_tweenTargetIsTargetGO);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DG.Tweening.DOTweenAnimation();
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DORewindAllById(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DORewindAllById( _id );
        ...
        static int _m_GetTweens(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetTweens(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _t = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        var gen_ret = DG.Tweening.DOTweenAnimation.TypeToDOTargetType( _t );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CreateEditorPreview(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.CreateEditorPreview(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_targetIsSelf(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.targetIsSelf);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_targetGO(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.targetGO);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_tweenTargetIsTargetGO(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.tweenTargetIsTargetGO);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_targetIsSelf(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.targetIsSelf = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_targetGO(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.targetGO = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_tweenTargetIsTargetGO(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.tweenTargetIsTargetGO = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_animationType(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                DG.Tweening.DOTweenAnimation.AnimationType gen_value;translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_targetType(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                DG.Tweening.DOTweenAnimation.TargetType gen_value;translator.Get(L, 2, out gen_value);
        ...
        static int _e_OnReset(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Action<DG.Tweening.DOTweenAnimation> gen_delegate = translator.GetDelegate<System.Action<DG.Tweening.DOTweenAnimation>>(L, 2);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#2 need System.Action<DG.Tweening.DOTweenAnimation>!");
                }
                
				
				if (gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					DG.Tweening.DOTweenAnimation.OnReset += gen_delegate;
					return 0;
				} 
			...
			return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.DOTweenAnimation.OnReset!");
        }
