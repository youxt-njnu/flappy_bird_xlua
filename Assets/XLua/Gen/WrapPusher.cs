...
namespace XLua
{
    public static partial class ObjectTranslator_Gen
    {
		public static void Init(LuaEnv luaenv, ObjectTranslator translator)
		{
			...
			DGTweeningDOTweenInspectorMode_TypeID = -1;
			DGTweeningDOTweenInspectorMode_EnumRef = -1;
			...
			translator.RegisterPushAndGetAndUpdate<DG.Tweening.DOTweenInspectorMode>(translator.PushDGTweeningDOTweenInspectorMode, translator.GetDGTweeningDOTweenInspectorMode, translator.UpdateDGTweeningDOTweenInspectorMode);
        ...
        static int DGTweeningDOTweenInspectorMode_TypeID = -1;
		static int DGTweeningDOTweenInspectorMode_EnumRef = -1;
        
        public static void PushDGTweeningDOTweenInspectorMode(this ObjectTranslator thiz, RealStatePtr L, DG.Tweening.DOTweenInspectorMode val)
        {
            if (DGTweeningDOTweenInspectorMode_TypeID == -1)
            {
			    bool is_first;
                DGTweeningDOTweenInspectorMode_TypeID = thiz.getTypeId(L, typeof(DG.Tweening.DOTweenInspectorMode), out is_first);
        ...
        public static void GetDGTweeningDOTweenInspectorMode(this ObjectTranslator thiz, RealStatePtr L, int index, out DG.Tweening.DOTweenInspectorMode val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
            ...
            {
                val = (DG.Tweening.DOTweenInspectorMode)thiz.objectCasters.GetCaster(typeof(DG.Tweening.DOTweenInspectorMode))(L, index, null);
            }
        }
		
        public static void UpdateDGTweeningDOTweenInspectorMode(this ObjectTranslator thiz, RealStatePtr L, int index, DG.Tweening.DOTweenInspectorMode val)
        {
